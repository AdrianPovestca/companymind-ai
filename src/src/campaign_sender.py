...
class TemplateParser:
    ...
    def parse(template: str, data: Dict[str, str]) -> str:
        ...
        for placeholder in re.findall(TemplateParser.PLACEHOLDER_PATTERN, template):
            ...
            value = data.get(key, f"[{placeholder}]")  # Fallback if key missing
...
class CampaignSender:
    ...
    def validate_recipients(self, recipients: List[Dict]) -> tuple[List[Dict], List[Dict]]:
    ...
    def send_email(self, to_email: str, subject: str, body: str, 
                   sender_email: str) -> tuple[bool, Optional[str]]:
